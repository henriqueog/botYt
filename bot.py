...
class Bot:
    ...
    def run(self):
        #HACK
        youtubeURLs = [
        'https://www.youtube.com/watch?v=-XHFydp7JEI,'
        'https://www.youtube.com/watch?v=fQd793UKd1w',
        'https://www.youtube.com/watch?v=Kxdu5j_qrKk',
        'https://www.youtube.com/watch?v=ljmLdCoVA9c',
        'https://www.youtube.com/watch?v=Kq7WE7sfoNw',
        'https://www.youtube.com/watch?v=rczq1U0muEw',
        'https://www.youtube.com/watch?v=U5uYnt2s828',
        'https://www.youtube.com/watch?v=jo27NnLtxVI',
        'https://www.youtube.com/watch?v=bUiUOM2-G3E',
        'https://www.youtube.com/watch?v=yXQ9MAOr7u4'
        ]
        # run
