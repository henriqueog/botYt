...
sleep 3
printf "\n\n\e[1;92m"
printf "Running \e[1;93mwget -N https://chromedriver.storage.googleapis.com/89.0.4389.23/chromedriver_linux64.zip\e[1;92m command ...\n"
sleep 3
wget -N https://chromedriver.storage.googleapis.com/89.0.4389.23/chromedriver_linux64.zip
printf "\n\n\e[1;92m"
